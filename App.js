...
const forecastapi = (city) =>
  `https://api.weatherapi.com/v1/forecast.json?key=5eb1392b80024f268bd102013231503&q=${city}&days=1&aqi=no&alerts=no`;
function App() {
  ...
  const handleclik = async (e) => {
    ...
    console.log(respp);
    setcurrent(respp.current);
    setforecast(respp.forecast);
    setlocation(respp.location);
  };
